<div class="col-lg-4 col-md-6">
      <div class="position-relative video-wrap mb-2" data-title="{{ $video->title }}">
          ...
          <a style="font-size:.8em" class="venobox_vid text-muted" title="{{ $video->mediable->name }}&nbsp;:&nbsp;{{ $video->title }}" data-gall="video_gallery" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/embed/{{ $video->source }}">{{ $video->title }}</a>
  </div>
</div>
  @push('jssnippets')
    // Initialize Venobox
